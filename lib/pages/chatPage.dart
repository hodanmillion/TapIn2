...
class ChatPage extends GetView<PrivateChatController> {
        ...
        child: Row(
          children: <Widget>[
            Obx(() => controller.selectedGifUrl.value.isEmpty
                ...
                : Column(
                    children: [
                      Image.network(controller.selectedGifUrl.value,
  ...
  Future<String> fetchSenderUsername(String senderId) async {
    ...
    try {
      DocumentSnapshot senderSnapshot = await usersCollection.doc(senderId).get();
  ...
  _handleSubmitted(String text) async {
    ...
    try {
      String token = await FireBaseNoti().getUserToken(controller.receiverUserID.value);
