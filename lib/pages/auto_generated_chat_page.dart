...
class ImageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Hero(
          tag: imageUrl, // Use the image URL as a hero tag
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            "You can chat with everyone in your current location.",
            style: GoogleFonts.openSans(
              textStyle:
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Expanded(
                  child: Obx(() {
                    final reversedMessages = controller.messagesList.reversed.toList();
    ...
    if (controller.messageTextCont.text.toString().trim().isNotEmpty ||
      ...
      controller.addAMessageToDB(
        messageVal: MessagePublicChat(
          ...
          isGif: controller.selectedGifUrl.value.isEmpty ? false : true,
        ),
      );
      controller.selectedGifUrl.value = '';
    }
